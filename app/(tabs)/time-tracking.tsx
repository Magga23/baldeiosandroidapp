...
export default function TimeTrackingScreen() {
  console.log('TimeTrackingScreen: Rendering time tracking menu');
  const theme = useTheme();
  const isDark = theme.dark;
  const themeColors = isDark ? colors.dark : colors.light;

  const handleClockIn = () => {
    console.log('TimeTrackingScreen: User tapped Clock In button, navigating to time-entry');
    router.push('/time-entry');
  };

  const handleTimeHistory = () => {
    console.log('TimeTrackingScreen: User tapped Time History button, navigating to time-history');
